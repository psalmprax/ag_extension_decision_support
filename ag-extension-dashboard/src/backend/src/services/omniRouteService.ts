...
export class OmniRouteService {
  ...
  public static readonly FREE_LLM_CATALOG: RouteCandidate[] = [
    ...
    // ═════════════════════════════════════════════════════════════════════
    { providerName: 'openrouter', model: 'minimax/minimax-m3:free', score: 94, isFree: true },
    { providerName: 'openrouter', model: 'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free', score: 93, isFree: true },
    { providerName: 'openrouter', model: 'nvidia/nemotron-3.5-lightning:free', score: 92, isFree: true },
    { providerName: 'openrouter', model: 'google/gemma-4-31b-it:free', score: 91, isFree: true },
    { providerName: 'openrouter', model: 'google/gemma-4-26b-a4b-it:free', score: 90, isFree: true },
    { providerName: 'openrouter', model: 'deepseek/deepseek-r1:free', score: 89, isFree: true },
    ...
    // ═════════════════════════════════════════════════════════════════════
    { providerName: 'nvidia', model: 'meta/llama-3.2-11b-vision-instruct', score: 86, isFree: true },
