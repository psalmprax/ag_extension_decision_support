...
export function ImageAnalysisTab({
    cropType, setCropType, radiusClass, btnClass, t, addNotification, getSeverityColor
}: Props) {
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    {imageAnalysis.diseases.map((disease) => (
                                        <div key={disease.disease} className={`p-3 border border-gray-200 dark:border-gray-700 ${radiusClass}`}>
