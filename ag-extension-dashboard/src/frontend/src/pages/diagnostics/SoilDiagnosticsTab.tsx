...
export function SoilDiagnosticsTab({
    cropType, setCropType, radiusClass, btnClass, addNotification
}: Props) {
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                ...
                                <div className="p-3 border border-gray-100 dark:border-gray-700 rounded-lg text-center bg-gray-50 dark:bg-gray-800/50">
                                    ...
                                    <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-semibold ${getNpkStatusClass(soilAnalysis.npkDeficiencies.nitrogen)}`}>
                                ...
                                <div className="p-3 border border-gray-100 dark:border-gray-700 rounded-lg text-center bg-gray-50 dark:bg-gray-800/50">
                                    ...
                                    <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-semibold ${getNpkStatusClass(soilAnalysis.npkDeficiencies.phosphorus)}`}>
                                ...
                                <div className="p-3 border border-gray-100 dark:border-gray-700 rounded-lg text-center bg-gray-50 dark:bg-gray-800/50">
                                    ...
                                    <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-semibold ${getNpkStatusClass(soilAnalysis.npkDeficiencies.potassium)}`}>
