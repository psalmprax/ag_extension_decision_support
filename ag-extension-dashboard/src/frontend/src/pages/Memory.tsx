  ...
  if (isLoading) {
    return (
      <LoadingHeaderSkeleton
        ...
        description="Manage AI persistent memory and knowledge"
      />
    );
  }
  ...
  return (
    <div className="space-y-6">
        ...
        <MetricCard
          ...
          value={
            memorySummary.length > 0
              ? (
                  memorySummary.reduce((acc, cat) => acc + cat.avgImportance, 0) /
      ...
      {memorySummary.length > 0 && (
        <div className="card p-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">
            {t('memory_category_summary')}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {memorySummary.map(category => (
              <div
                key={category.category}
                className={`p-4 bg-gray-50 dark:bg-gray-800 ${radiusClass}`}
              >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setNewMemory(prev => ({ ...prev, importance: parseFloat(e.target.value) }))
                    }
                    className="w-full"
                  />
                </div>
