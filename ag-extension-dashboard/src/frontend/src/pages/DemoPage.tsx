            ...
            <div className="max-w-5xl mx-auto px-6 py-12">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-stone-400 max-w-lg mx-auto">
                        Explore the AI-powered capabilities that help agricultural extension officers make data-driven decisions in the field.
                    </p>
                </div>
                ...
                <div className="flex gap-2 mb-8 bg-white/5 p-1.5 rounded-xl border border-white/5 max-w-xl mx-auto">
                    {[
                        ...
                        { key: 'synthesis' as const, icon: Smartphone, label: 'Voice Synthesis', color: 'text-emerald-400' },
                        { key: 'telemetry' as const, icon: Database, label: 'Soil Telemetry', color: 'text-cyan-400' },
                    ].map(tab => (
                        <button
                            key={tab.key}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-5 rounded-xl bg-black/40 border border-white/5 min-h-[200px]">
                                <div className="flex items-center gap-2 border-b border-white/5 pb-3 mb-4">
                                    ...
                                    <span className="text-xs font-bold font-mono text-stone-400">RAG v2 Assistant Response</span>
                                </div>

                                {ragStep === 0 && (
                                    <p className="text-sm text-stone-500 italic">
                                        Click one of the scenarios above to see the AI assistant retrieve and synthesize agronomic knowledge in real time.
                                    </p>
                                )}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center gap-3 p-4 rounded-xl bg-cyan-500/5 border border-cyan-500/10">
                                ...
                                <p className="text-xs text-stone-400">
                                    Data sourced from NASA POWER, SoilGrids v2, and FAOSTAT APIs. All metrics are region-specific and updated in real time when connected.
                                </p>
                            </div>
                        </div>
                    )}
