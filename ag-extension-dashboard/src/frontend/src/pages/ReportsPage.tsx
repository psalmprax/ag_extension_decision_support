...
export function ReportCard({
    ...
    const { t } = useLanguage();
    return (
        <div className="card group p-6 bg-theme-bg-card dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-primary-500 dark:hover:border-primary-400 transition-all cursor-pointer shadow-sm hover:shadow-xl"
            onClick={async () => {
...
export const ReportsPage: React.FC<ReportsPageProps> = ({
    reports, handleGenerateReport, isGeneratingReport,
    viewingReport: _viewingReport, setViewingReport,
