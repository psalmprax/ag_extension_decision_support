          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div
                  className={`flex items-center gap-1 text-xs font-bold ${
                    analytics.revenue.netRevenueChange >= 0 ? 'text-green-200' : 'text-red-200'
                  }`}
                >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div
                  className={`flex items-center gap-1 text-xs font-bold ${
                    analytics.customers.churnRate <= 5 ? 'text-green-200' : 'text-red-200'
                  }`}
                >
              ...
              <h3 className="text-2xl font-black mb-1">
                {formatPercentage(analytics.customers.retentionRate)}
              </h3>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left py-3 px-4 font-black text-gray-900 dark:text-white">
                      Period
                    </th>
                    <th className="text-center py-3 px-4 font-black text-gray-900 dark:text-white">
                      Customers
                    </th>
                    <th className="text-center py-3 px-4 font-black text-gray-900 dark:text-white">
                      Retained
        ...
        <div className="xl:col-span-4 space-y-8">
          ...
          >
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`text-lg font-black ${
                    analytics.churnPrediction.predictedChurnRate > 10
                      ? 'text-red-600 dark:text-red-400'
                      : 'text-green-600 dark:text-green-400'
                  }`}
                >
            ...
            <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
              <h4 className="text-sm font-black text-gray-900 dark:text-white mb-3">
                Top Churn Reasons
              </h4>
