...
export const MapLegend: React.FC<MapLegendProps> = ({ show, t }) => {
  ...
  return (
    ...
    >
      <div className="leaflet-control bg-slate-900/95 text-white backdrop-blur-xl rounded-xl shadow-xl border border-white/10 p-2.5 sm:p-3.5 min-w-[120px] sm:min-w-[170px]">
        <button
