...
export const SubscriptionStatus: React.FC<SubscriptionStatusProps> = ({
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-8">
            <div
              className={`p-4 bg-white/10 ${radiusClass} backdrop-blur-xl border border-white/20 shadow-xl`}
            >
              <Zap className="w-8 h-8 text-primary-400 transition-transform group-hover:rotate-12 duration-500" />
            </div>
            <div className="flex flex-col items-end">
              <span className="text-xxs font-black uppercase tracking-widest text-primary-300 mb-1">
          ...
          <span
            ...
            className="text-xxs font-black uppercase tracking-widest text-white/50 mb-2 block"
          >
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <div
          className={`p-5 bg-primary-500/10 ${radiusClass} border border-primary-500/20 w-fit mb-8 shadow-inner`}
        >
      ...
      <div
        className={`relative z-10 p-6 bg-white/5 ${radiusClass} border border-white/5 backdrop-blur-sm`}
      >
        <div className="flex items-center gap-3 text-primary-400 font-black text-xxs uppercase tracking-widest mb-2">
