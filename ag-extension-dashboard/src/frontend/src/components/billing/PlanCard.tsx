  ...
  return (
    ...
    >
      ...
      {plan.id === 'price_pro_monthly' && (
        <div
          className={`mb-6 inline-flex px-4 py-1.5 bg-indigo-500/10 text-indigo-500 text-xxs font-black ${radiusClass} uppercase tracking-[0.2em] border border-indigo-500/20 backdrop-blur-md relative z-10 w-fit`}
        >
      ...
      {plan.id === 'price_free' && (
        <div
          className={`mb-6 inline-flex px-4 py-1.5 bg-primary-500/10 text-primary-500 text-xxs font-black ${radiusClass} uppercase tracking-[0.2em] border border-primary-500/20 backdrop-blur-md relative z-10 w-fit`}
        >
        ...
        <div className="flex justify-between items-start mb-10">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-xxs font-black text-primary-500 uppercase tracking-[0.2em] italic">
                {t('plan_tier_operational')}
              </p>
            </div>
          </div>
          <div className="flex flex-col items-end">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-gray-400 font-bold uppercase text-xxs tracking-widest">
                /{plan.interval}
              </span>
            </div>
          </div>
        ...
        <div className="space-y-6 mb-16">
          {plan.features.map((feature, i) => (
            <div key={i} className="flex items-center gap-5 group/feature">
              <div
                className={`shrink-0 p-1.5 ${radiusClass} bg-primary-500/10 border border-primary-500/20 group-hover/feature:bg-primary-500 group-hover/feature:scale-110 transition-all duration-500`}
              >
                <CheckCircle className="w-4 h-4 text-primary-500 group-hover/feature:text-white" />
              </div>
              <span className="text-xxs font-black uppercase tracking-widest text-gray-500 dark:text-gray-400 group-hover/feature:text-gray-900 dark:group-hover/feature:text-white transition-colors duration-300">
                {t(feature)}
              </span>
            </div>
          ))}
