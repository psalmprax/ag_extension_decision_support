                        ...
                        {navItems.map((item) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    activeTab === item.id
                                        ? 'bg-primary-600/10 dark:bg-primary-500/10 text-primary-600 dark:text-primary-400 border-r-2 border-primary-600 dark:border-primary-400 shadow-[inset_0_0_15px_rgba(var(--color-primary-500-rgb),0.1)]'
