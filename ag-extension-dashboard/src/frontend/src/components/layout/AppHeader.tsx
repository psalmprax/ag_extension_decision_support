...
export const AppHeader: React.FC<AppHeaderProps> = ({
    ...
    const headerClass = cn(
        'sticky top-0 z-50 flex justify-between items-center px-6 h-16 backdrop-blur-xl border-b border-gray-200 dark:border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.1)] transition-all duration-300',
        'w-full',
