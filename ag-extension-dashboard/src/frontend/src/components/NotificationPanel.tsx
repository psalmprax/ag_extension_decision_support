              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xxs text-gray-400 font-bold uppercase tracking-widest">
                    {unreadCount} {t('common_unread') || 'Unread'} · {displayNotifications.length}{' '}
              ...
              {isLoadingApi ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-center p-8 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xxs text-gray-400 dark:text-gray-500 mt-1 uppercase tracking-widest">
                  ...
                  >
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p
                          className={`text-sm leading-relaxed ${notification.read ? 'text-gray-500' : 'text-gray-900 dark:text-white font-medium'}`}
                        >
