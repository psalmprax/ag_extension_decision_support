...
const fetchSystemHealth = async (setHealthScore: (score: number) => void, setIndicators: (indicators: SystemIndicator[]) => void, setUptime: (uptime: string) => void) => {
    try {
...
const SystemOverview: React.FC<SystemOverviewProps> = ({ 
    ...
    const { healthScore, indicators, uptime } = useSystemHealth(externalHealthScore, externalIndicators);
