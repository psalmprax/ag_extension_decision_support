...
export const BulkSmsModal: React.FC<BulkSmsModalProps> = ({
    ...
    const templates = [
        { id: 'urgent', text: "URGENT: New agricultural updates for your area. Please check the USSD menu *384*100# or contact your extension officer." },
        { id: 'meeting', text: "REMINDER: Farmers group meeting tomorrow at 09:00 AM at the community center. Please attend." },
        { id: 'survey', text: "SURVEY: We are conducting a crop yield assessment. Your participation is valuable. Dial *384*100# to respond." }
    ];
                        ...
                        <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900 dark:text-white">Bulk SMS Composer</h3>
