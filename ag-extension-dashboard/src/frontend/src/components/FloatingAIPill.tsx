      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 md:bottom-6 md:right-6 z-[1100] w-[calc(100vw-2rem)] sm:w-[420px] max-w-[420px] max-h-[85vh] h-[85vh] bg-slate-950/95 border border-emerald-500/30 rounded shadow-2xl backdrop-blur-2xl flex flex-col overflow-hidden text-slate-100 shadow-emerald-950/80"
          >
            {/* Drawer Header */}
            ...
            <div className="flex-1 p-4 overflow-y-auto space-y-3">
              ...
              {activeTab === 'scan' && (
                <div className="space-y-4">
                  <div className="p-4 rounded border-2 border-dashed border-slate-800 hover:border-emerald-500/50 bg-slate-900/40 text-center transition-all">
                  ...
                  {voiceTranscript && (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded transition-colors"
                      >
                ...
                <div className="space-y-4 text-center p-2">
                  <div className="p-5 rounded bg-slate-900 border border-emerald-500/30 space-y-3">
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded transition-all shadow-md shadow-emerald-950 flex items-center justify-center gap-2"
                    >
              ...
              <form onSubmit={handleSendMessage} className="p-3 border-t border-slate-800 bg-slate-900/80">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-slate-950 border border-slate-700 rounded px-3 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-emerald-400 transition-colors"
                  />
                  <button
                    type="submit"
                    className="p-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded transition-all shadow-md shadow-emerald-950"
                  >
