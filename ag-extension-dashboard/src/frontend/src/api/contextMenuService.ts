...
export const getStaticFallbackMenu = (entityType: string): ContextMenuData => {
        ...
        farmer: {
            ...
            sections: [
                ...
                },
                {
                    id: 'danger',
                    items: [
                        { id: 'delete', label: 'Delete', icon: 'trash', action: 'delete_farmer' }
                    ]
                }
            ]
        },
            ...
            sections: [
                {
                    ...
                    items: [
                        ...
                        { id: 'complete', label: 'Mark Complete', icon: 'check-square', action: 'complete_visit' },
                    ]
                }
            ]
        },
    ...
    return fallbackMenus[entityType] || {
        entityType,
        sections: [{
            id: 'default',
            items: [
                { id: 'view', label: 'View', icon: 'eye', action: `view_${entityType}` }
            ]
        }]
    };
};
