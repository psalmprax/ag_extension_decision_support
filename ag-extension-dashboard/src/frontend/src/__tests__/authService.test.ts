        ...
        it('should send credentials and return auth response', async () => {
            const mockResponse = {
                data: {
                    ...
                    data: {
                        token: 'jwt-token-123',
                        user: { id: '1', email: 'test@test.com', role: 'admin' as const, firstName: 'Test', lastName: 'User' },
                    },
                },
            };
        ...
        it('should call demo endpoint', async () => {
            const mockResponse = {
                data: {
                    ...
                    data: {
                        token: 'demo-token',
                        user: { id: '1', email: 'demo@agridemo.com', role: 'extension_officer' as const, firstName: 'Demo', lastName: 'User' },
                    },
                },
            };
            mockPost.mockResolvedValue(mockResponse);
        ...
        it('should send registration data', async () => {
            mockPost.mockResolvedValue({
                data: {
                    ...
                    data: {
                        token: 'new-token',
                        user: { id: '2', email: 'new@test.com', role: 'farmer' as const, firstName: 'New', lastName: 'User' },
                    },
                },
            });
    ...
    describe('fetchUserProfile', () => {
        it('should fetch current user profile', async () => {
            mockGet.mockResolvedValue({
                data: {
                    success: true,
                    data: { id: '1', email: 'test@test.com', role: 'admin', firstName: 'Test', lastName: 'User' },
                },
            });
