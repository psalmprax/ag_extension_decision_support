...
export const DEMO_LEADERBOARD = [
  {
    ...
    officerName: 'Samuel Omondi',
    region: 'Machakos',
    visitsCompleted: 42,
    outcomesRecorded: 28,
    efficacySuccessRate: 94,
    farmersSupported: 36,
    score: 186.8,
    badges: ['Road Warrior', 'Trusted Advisor'],
  },
  {
    officerId: 'demo-officer-2',
    officerName: 'Faith Chebet',
    region: 'Uasin Gishu',
    visitsCompleted: 35,
    outcomesRecorded: 22,
    efficacySuccessRate: 91,
    farmersSupported: 29,
    score: 154.2,
    badges: ['Field Regular', 'Trusted Advisor'],
  },
  {
    officerId: 'demo-officer-3',
    officerName: 'David Kiprono',
    region: 'Nakuru',
    visitsCompleted: 28,
    outcomesRecorded: 18,
    efficacySuccessRate: 88,
    farmersSupported: 25,
    score: 127.6,
    badges: ['Field Regular', 'Evidence Collector'],
  },
  {
    officerId: 'demo-officer-4',
    officerName: 'Amina Hassan',
    region: 'Kilifi',
    visitsCompleted: 24,
    outcomesRecorded: 15,
    efficacySuccessRate: 85,
    farmersSupported: 21,
    score: 110.0,
    badges: ['Field Regular', 'Outcome Tracker'],
  },
  {
    officerId: 'demo-officer-5',
    officerName: 'Joseph Mutua',
    region: 'Meru',
    visitsCompleted: 19,
    outcomesRecorded: 12,
    efficacySuccessRate: 82,
    farmersSupported: 18,
    score: 90.4,
    badges: ['Outcome Tracker'],
  },
];
