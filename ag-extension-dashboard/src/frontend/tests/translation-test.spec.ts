...
test.describe('Menu Translation Tests', () => {
    test('should translate both menu and right panel content', async ({ page }) => {
        ...
        console.log('Contains "Dashboard" (should be false):', frenchPageContent.includes('"Dashboard"'));
    ...
    test('verify right panel content translates', async ({ page }) => {
        ...
        console.log('French - has "Portefeuille de Visites":', frContent.includes('Portefeuille de Visites'));
