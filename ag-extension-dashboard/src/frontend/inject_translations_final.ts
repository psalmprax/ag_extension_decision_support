...
const newKeys = {
  ...
  billing_change_plan_modal_desc:
    'Select a new plan tier for your account. Changes will take effect immediately.',
...
const arGaps = {
  ...
  usage_init_desc:
    'افتح إمكانات الذكاء الاصطناعي والرسائل النصية القصيرة من خلال اختيار خطة النشر.',
...
languages.forEach(lang => {
  ...
  updatedContent =
    updatedContent.substring(0, startIndex) + newBlock + updatedContent.substring(endIndex);
});
