    ...
    <div className="w-[360px] bg-slate-900 text-white shadow-2xl overflow-hidden font-sans">
      ...
      <main className="p-4 space-y-4">
        ...
        <section className="space-y-2">
          ...
          <div className="p-3 bg-slate-800/50 rounded-xl border border-slate-700/50 hover:border-primary-500/30 transition-all cursor-pointer group">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-bold text-white group-hover:text-primary-400 transition-colors">AGENT ALPHA</h3>
        ...
        <section className="grid grid-cols-2 gap-3">
          <button className="p-3 bg-slate-800/50 rounded-xl border border-slate-700/50 hover:bg-slate-800 flex flex-col items-center gap-2 transition-all">
        ...
        <section className="p-3 bg-primary-900/10 rounded-xl border border-primary-500/10">
          ...
          <p className="text-xs text-slate-300 leading-relaxed">
            Agricultural context detected on this page. Press <kbd className="px-1.5 py-0.5 rounded bg-slate-700 text-[10px] border border-slate-600">⌘⇧A</kbd> to activate side-panel assistance.
          </p>
        </section>
      </main>

      {/* Footer */}
      <footer className="p-3 bg-slate-950/50 border-t border-slate-800/50 flex items-center justify-center gap-2">
